...
const Featured = () => {
  ...
  const styles = {
    container: `h-[400px] w-[90%] flex p-[20px] flex-col`,
    title: `text-2xl font-bolder mb-[20px] mt-[30px] mb-24 pl-[40px]`,
    cards: `h-full w-full flex gap-[100px] justify-between mb-[30px] pl-[30px]`,
